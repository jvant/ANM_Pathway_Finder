...
void Read_inputs(int *Num_particles, double *cutoff_1, double *cutoff_2, double *force_constant_1, double *force_constant_2)
{
  FILE *in;
  char key[1000];
...
int main()
{
  ...
  Read_inputs(&Num_particles, &cutoff_1, &cutoff_2, &force_constant_1, &force_constant_2);
  ...
  /* Calculate energy*/
  Calc_energies_along_pathway(Num_particles, &fr_ref_1, &fr_ref_2, force_constant_1, force_constant_2, cutoff_1, cutoff_2, pair_distances_structure_1, pair_distances_structure_2, Num_struct_in_pathway, index_of_ts_struct);
