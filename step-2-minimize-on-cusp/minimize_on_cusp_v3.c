...
int main()
{
  ...
  Choose_step_size(Num_particles, force_constant_1, force_constant_2, cutoff_1, cutoff_2, pair_distances_structure_1, pair_distances_structure_2, tol, Num_images, &fr_end_1, &fr_end_2, &fr_1, &fr_2, &fr_try_1, &fr_try_2, &fr_new, &fr_cusp, Reference_x, Reference_y, Reference_z, Num_points, step_size_reduction_factor_1, step_size_reduction_factor_2, &step_size_1, &step_size_2);
  ...
  potential_1 = getforces_enm_return_pot(&fr_cusp, pair_distances_structure_1, cutoff_1, force_constant_1);
  potential_2 = getforces_enm_return_pot(&fr_cusp, pair_distances_structure_2, cutoff_2, force_constant_2);
  ...
  do
    {
      ...
      getforces_enm(&fr_end_1, pair_distances_structure_1, cutoff_1, force_constant_1);
      /** Energy Surface 2**/
      Copy_config(Num_particles, &fr_cusp, &fr_end_2);
      getforces_enm(&fr_end_2, pair_distances_structure_2, cutoff_2, force_constant_2);
      /** Minimize**/
      for(i = 0 ; i < Num_particles ; i++)
        {
      ...
      Find_strucutre_on_cusp(Num_particles, &fr_end_1, &fr_end_2, tol, Num_images, pair_distances_structure_1, cutoff_1, force_constant_1, pair_distances_structure_2, cutoff_2, force_constant_2, &fr_1, &fr_2, &fr_try_1, &fr_try_2, &fr_new, &fr_cusp);
