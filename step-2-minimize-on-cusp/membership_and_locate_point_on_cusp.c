...
#include "membership_and_locate_point_on_cusp.h"
 ...
 */
int Find_membership(FR_DAT *fr, double **pair_distances_structure_1, double cutoff_1, double force_constant_1, double **pair_distances_structure_2, double cutoff_2, double force_constant_2, double tol)
{
  double energy_1, energy_2;
  
  energy_1 = getforces_enm_return_pot(fr, pair_distances_structure_1, cutoff_1, force_constant_1);
  energy_2 = getforces_enm_return_pot(fr, pair_distances_structure_2, cutoff_2, force_constant_2);
...
void Find_strucutre_on_cusp(int Num_atoms, FR_DAT *fr_end_1, FR_DAT *fr_end_2, double tol, int Num_images, double **pair_distances_structure_1, double cutoff_1, double force_constant_1, double **pair_distances_structure_2, double cutoff_2, double force_constant_2, FR_DAT *fr_1, FR_DAT *fr_2, FR_DAT *fr_try_1, FR_DAT *fr_try_2, FR_DAT *fr_new, FR_DAT *fr_cusp)
{
  int alpha;
  ...
  do
    {
	  ...
	  membership_current = Find_membership(fr_new, pair_distances_structure_1, cutoff_1, force_constant_1, pair_distances_structure_2, cutoff_2, force_constant_2, tol);
